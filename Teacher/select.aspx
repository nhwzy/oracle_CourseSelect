<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="select.aspx.cs" Inherits="小型管理信息系统.Teacher.select" %>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="Black" GridLines="Vertical" HorizontalAlign="Center" Width="722px">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="SNO" HeaderText="学生学号" SortExpression="SNO" />
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="select C.CNO,C.CNAME,S.SNO,S.SNAME from APPLY left join C on C.CNO=APPLY.CNO left join S on S.SNO=APPLY.SNO order by C.CNO"></asp:SqlDataSource>
